<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="NewsBlog.aspx.cs" Inherits="chandIT.NewsBlog" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ul>
      <li><a href="#">tempor cum soluta nobis eleifend</a></li>
      <li><a href="#">demonstraverunt lectores</a></li>
  ...
  <div id="left"><span class="headline_three">Blogs in my network</span><br />
    ...
    <ul>
      <li><a href="#">Full Ahead</a></li>
      <li><a href="#">Caperweb Interactive</a></li>
      <li><a href="#">Jason Cole</a></li>
      <li><a href="#">Lobster man</a></li>
      <li><a href="#">Karen Blundell</a></li>
      <li><a href="#">Writeside</a></li>
      <li><a href="#">idunzo</a></li>
      <li><a href="#">Attackr</a></li>
      <li><a href="#">Growl design</a></li>
      <li><a href="#">Edg3</a></li>
    </ul>
    <span class="headline_three">Lorem dolor sit amet</span><br />
    <span class="small_caps">demonstraverunt</span>
  ...
  <div id="right">
    <div class="content"> <span class="headline_one">Stop being fooled</span><br />
      ...
      <br />
      <span class="number">.01 |</span> <a href="#" class="headline_url">Claritas est etiam processus</a><br />
      ...
      <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum.</p>
      <div class="comment_box"><a href="#">Comments (9)</a> </div>
    </div>
    <div class="content"><span class="headline_one">Mirum est notare quam</span><br />
      ...
      <br />
      <span class="number">.02 |</span> <a href="#" class="headline_url">putamus parum claram</a><br />
      ...
      <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum.</p>
      <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum.</p>
      <div class="comment_box"><a href="#">Comments (21)</a></div>
    </div>
    </div>
</asp:Content>
